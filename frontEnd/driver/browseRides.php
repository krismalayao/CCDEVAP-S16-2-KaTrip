        ...
        <main class="browserides-main">
            ...
            <div class="browserides-card">
                ...
                <div class="browserides-filter-panel" id="panel-destination">
                    <div class="browserides-destination-select-wrap">
                        <select class="browserides-destination-select" id="destination-select">
                            <option value="">All destinations</option>
                            <option value="españa">Espana, Manila</option>
                            <option value="quiapo">Quiapo, Manila</option>
                            <option value="divisoria">Divisoria, Manila</option>
                            <option value="tondo">Tondo, Manila</option>
                            <option value="malate">Malate, Manila</option>
                            <option value="ermita">Ermita, Manila</option>
                        </select>
                        <span class="browserides-select-arrow">▾</span>
                    </div>
                </div>
                ...
                <div class="browserides-filter-panel hidden" id="panel-pickup">
                    <p class="browserides-filter-hint">Showing rides nearest to your location first</p>
                </div>
